...
use App\Form\CategoryPersoType;
...
class CategoryPersoController extends AbstractController
{
    /**
     * @Route("/categoryPerso", name="category_add")
     * @return Response A response instance
     */
    public function add(Request $request) :Response
    {
        $category = new Category();
        $addCategory = $this->createForm(CategoryPersoType::class, $category);
        ...
        return $this->render('categoryPerso/add.html.twig', ['add'=>$addCategory->createView()]);
    }

    /**
     * @param string $category the slugger
     * @Route("/categoryPerso/{category<^[a-z-]+$>}", name="blog_show_category")
     * @return Response A response instance
     */
    ...
    /**
     * @Route("/categoryPerso/{id}", name="category_detail")
     */
    public function show(Category $category) :Response
    {
        return $this->render('categoryPerso/category.html.twig', ['category' => $category]);
    }
